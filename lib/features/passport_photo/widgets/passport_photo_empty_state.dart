...
class PassportPhotoEmptyState extends StatefulWidget {
  ...
  @override
  State<PassportPhotoEmptyState> createState() => _PassportPhotoEmptyStateState();
}

class _PassportPhotoEmptyStateState extends State<PassportPhotoEmptyState> {
  ...
  Future<void> _loadRecents() async {
    final list = await RecentProjectsService.getRecentProjects();
    if (mounted) {
      setState(() {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Icon(Icons.add_a_photo_outlined, size: 28, color: palette.blue),
                    ),
                    ...
                    // Subtitle
                    Text(
                      'Upload a photo to print Passport, Pass+Stamp, 4R, or A4 photos with studio borders and finishes.',
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          TextButton.icon(
                            onPressed: () async {
                              await RecentProjectsService.clearAll();
                              _loadRecents();
                            },
